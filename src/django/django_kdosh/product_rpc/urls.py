...
from .views import update_catalogs, get_catalogs, save_product, search_product, get_purchase_order_product, save_order, get_report, get_attribute_vals, sort_attribute_vals
