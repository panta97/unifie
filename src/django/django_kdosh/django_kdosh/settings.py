...
ODOO_URL = os.getenv("ODOO_URL", "https://kdoshstore-dev-30172674.dev.odoo.com")
ODOO_DB = os.getenv("ODOO_DB", "kdoshstore-dev-30172674")
ODOO_PWD = os.getenv("ODOO_PWD", "ebaa2b2f596c345e4512c78ce5fce87109c13536")
ODOO_UID = os.getenv("ODOO_UID", "2")
