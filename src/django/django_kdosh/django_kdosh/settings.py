...
ODOO_URL = os.getenv("ODOO_URL", "https://kdoshstore-dev-23005650.dev.odoo.com")
ODOO_DB = os.getenv("ODOO_DB", "kdoshstore-dev-23005650")
ODOO_PWD = os.getenv("ODOO_PWD", "44e49d2fe3c04ccdeb8d2ae99ab45fb89b910449")
ODOO_UID = os.getenv("ODOO_UID", "2")