...
ODOO_URL = os.getenv("ODOO_URL", "https://kdoshstore-dev-26661588.dev.odoo.com")
ODOO_DB = os.getenv("ODOO_DB", "kdoshstore-dev-26661588")
ODOO_PWD = os.getenv("ODOO_PWD", "941154975cd263bda769d586a5c66c14c3d06474")
ODOO_UID = os.getenv("ODOO_UID", "2")
