...
ODOO_URL = os.getenv("ODOO_URL", "https://kdoshstore-dev-24561843.dev.odoo.com")
ODOO_DB = os.getenv("ODOO_DB", "kdoshstore-dev-24561843")
ODOO_PWD = os.getenv("ODOO_PWD", "05e3fa1abcdc31241a09c7186a1a29ee208b774b")
ODOO_UID = os.getenv("ODOO_UID", "2")
