    ...
    try:
        ...
        for idx, snapshot in enumerate(snapshots, start=1):
            snapshot_list.append({
                ...
                "pos_cash": snapshot["pos_cash"],
                "pos_card": snapshot["pos_card"],
                "odoo_cash": snapshot["odoo_cash"],
                "odoo_card": snapshot["odoo_card"],
                "balance_start_next_day": snapshot["balance_start_next_day"],
                "end_state": snapshot["end_state"],
                "end_state_amount": snapshot["end_state_amount"],
